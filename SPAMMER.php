...
#Dilarang copyright RyuXploit - ScriptKiddies 2019 29 12 06:24
...
echo $B."\n::#:Instagram ::[@jayakusuma404:]#";

echo $RR."\n::#:Github ::[http://github.com/RyuXploit:] #";

echo $R."\n::#:Facebook ::[Jaya kusuma:] #";

echo $G."\n::#:YouTube ::[Script Kiddies:] #";

echo $GG."\n::#:Team ::[Probolinggo Cyber Security] #";
...
isset($argv[1]) OR die($RR."[!] []== MASUKAN NOMERNYA ==[] [!]\n".$X);

if(is_numeric($argv[1])) {

	echo "[]LOADING TO SPAM[] #".$G.$argv[1].$X."\n";
	...
	while(1) {
		...
		echo "[]SENDING TO SPAM[] # ".$G.$argv[1].$X."\n";	
...
echo "[]LOADING TO SPAM[] #".$G.$argv[2].$X."\n";
...
echo "[]SENDING TO SPAM[] # ".$G.$argv[2].$X."\n";
